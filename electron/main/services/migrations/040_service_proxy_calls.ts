...
export const name = '039_service_proxy_calls'
...
// sobreviver à limpeza de sessions. `error` já chega REDIGIDO (o proxy passa
// tudo por createSecretRedactor antes de persistir).
