...
import { applyImport, scanEnvSources, secretFingerprint, type EnvImportDeps } from './env-import'
...
describe('CM_ENV_IMPORT_ROOT', () => {
  it('redireciona a raiz do scan quando setada (gate de e2e; sem ela vale o home)', () => {
...
describe('applyImport', () => {
  it('relê o arquivo na hora e grava via setEnvVar; valor não aparece no retorno', () => {
    ...
    const result = applyImport(
      ...
      deps({ files: { [`${ROOT}/a/.env`]: 'K=secret-value-777\n' } }, { setEnvVar }),
    )
